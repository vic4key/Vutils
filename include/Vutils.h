...
#define SMTypes template <typename ServiceT, typename TDependentT, typename StringT, typename CharT>
#define SMDeclares ServiceT, TDependentT, StringT, CharT
...
public:
  ...
  typedef std::vector<TDependentT> TDependents;
